              ...
              <tr>
                <td class="content-padding" style="padding: 29px 26px 37px; ">
                  ...
                  <div style="margin-bottom: 50px;">
                    <a href="${FRONTEND_URL}/account/orders/${order.id}" style="background-color: ${ACCENT_COLOR}; color: #ffffff; text-decoration: none; padding: 13px 47px; font-size: 16px; font-weight: 500; display: inline-block;">Track Your Order</a>
                  </div>
                    ...
                    ${(order.items || []).map(item => `
                      <tr>
                        ...
                        <td width="90" align="center" valign="middle" bgcolor="#f5f5f5" style="width: 90px; padding: 8px; background-color: #f5f5f5; border-top: 1px solid #f0f0f0; text-align: center; vertical-align: middle;">
                          <img
                            src="${BACKEND_URL}${item.product?.productImage?.sizes?.emailThumb?.url || item.product?.productImage?.url || ''}"

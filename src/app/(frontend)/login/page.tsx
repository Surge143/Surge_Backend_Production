...
export default function LoginPage() {
  ...
  // Check for Apple auth error returned via query param
  useEffect(() => {
  ...
  const handleAppleLogin = async () => {
    try {
      ...
      setError('')
      // NextAuth handles the full OAuth redirect to Apple and back.
      // The callbackUrl points to our bridge route that sets the Payload cookie.

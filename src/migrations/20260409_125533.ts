...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_users_referral_status" AS ENUM('pending', 'rewarded', 'not_eligible');
  ...
  CREATE TYPE "public"."enum_menu_customizations_sections_selection_type" AS ENUM('single', 'multiple');
  ...
  CREATE TYPE "public"."enum_surge_coupon_coupon_status" AS ENUM('active', 'inactive');
  CREATE TYPE "public"."enum_surge_coupon_discount_type" AS ENUM('percentage', 'fixed');
  CREATE TYPE "public"."enum_surge_coupon_applicability" AS ENUM('all', 'products');
  CREATE TYPE "public"."enum_surge_coupon_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__surge_coupon_v_version_coupon_status" AS ENUM('active', 'inactive');
  CREATE TYPE "public"."enum__surge_coupon_v_version_discount_type" AS ENUM('percentage', 'fixed');
  CREATE TYPE "public"."enum__surge_coupon_v_version_applicability" AS ENUM('all', 'products');
  CREATE TYPE "public"."enum__surge_coupon_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum_surge_shop_coupon_coupon_status" AS ENUM('active', 'inactive');
  CREATE TYPE "public"."enum_surge_shop_coupon_discount_type" AS ENUM('percentage', 'fixed');
  CREATE TYPE "public"."enum_surge_shop_coupon_applicability" AS ENUM('all', 'products');
  CREATE TYPE "public"."enum_surge_shop_coupon_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__surge_shop_coupon_v_version_coupon_status" AS ENUM('active', 'inactive');
  CREATE TYPE "public"."enum__surge_shop_coupon_v_version_discount_type" AS ENUM('percentage', 'fixed');
  CREATE TYPE "public"."enum__surge_shop_coupon_v_version_applicability" AS ENUM('all', 'products');
  CREATE TYPE "public"."enum__surge_shop_coupon_v_version_status" AS ENUM('draft', 'published');
  ...
  CREATE TYPE "public"."enum_app_orders_app_order_status" AS ENUM('pending', 'preparing', 'ready', 'completed', 'cancelled');
  CREATE TYPE "public"."enum_app_orders_app_order_status_dine" AS ENUM('pending', 'preparing', 'ready', 'completed', 'cancelled');
  CREATE TYPE "public"."enum_app_orders_payment_status" AS ENUM('pending', 'paid', 'failed', 'refund-initiated', 'refunded');
  ...
  CREATE TYPE "public"."enum_web_products_product_type" AS ENUM('coffee', 'merchandise');
  CREATE TYPE "public"."enum_web_products_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__web_products_v_version_product_type" AS ENUM('coffee', 'merchandise');
  CREATE TYPE "public"."enum__web_products_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum_user_surge_coins_coin_earning_history_type" AS ENUM('offline', 'online');
  CREATE TYPE "public"."enum_user_surge_coins_points_redemption_history_type" AS ENUM('offline', 'online');
  ...
  CREATE TYPE "public"."enum_web_orders_origin" AS ENUM('one-time');
  ...
  CREATE TYPE "public"."enum_web_orders_payment_status" AS ENUM('pending', 'completed', 'failed', 'refund-initiated', 'refunded');
  CREATE TYPE "public"."enum_web_orders_delivery_status" AS ENUM('placed', 'shipped', 'delivered', 'cancelled', 'refund-initiated', 'refunded');
  CREATE TYPE "public"."enum_slots_time_selection" AS ENUM('now', 'custom');
  CREATE TYPE "public"."enum_surge_stamps_stamp_earning_history_type" AS ENUM('offline', 'online');
  CREATE TYPE "public"."enum_surge_stamps_stamps_redemption_history_type" AS ENUM('offline', 'online');
  CREATE TYPE "public"."enum_app_contact_form_inquiry_type" AS ENUM('order_issue', 'payment_refund', 'rewards_stamps', 'barista_selection', 'pickup_timing', 'menu_availability', 'other');
  CREATE TYPE "public"."enum_web_contact_form_inquiry_type" AS ENUM('order_issue', 'payment_refund', 'rewards_stamps', 'barista_selection', 'pickup_timing', 'menu_availability', 'other');
  CREATE TYPE "public"."enum_notifications_notifications_origin" AS ENUM('cafe', 'store');
  CREATE TYPE "public"."enum_notifications_notifications_notification_type" AS ENUM('general', 'order', 'reward');
  ...
  CREATE TYPE "public"."enum_app_banners_page" AS ENUM('Home', 'Cafe', 'Store');
  ...
  CREATE TABLE "users_addresses" (
  	...
  	"apartment" varchar,
  	"city" varchar,
  	"emirates" "enum_users_addresses_emirates",
  ...
  CREATE TABLE "users" (
  	...
  	"referral_code_input" varchar,
  	"referral_status" "enum_users_referral_status" DEFAULT 'not_eligible',
  	"barcode_token" varchar,
  	"apple_sub_id" varchar,
  	"is_apple_private_email" boolean DEFAULT false,
  ...
  CREATE TABLE "menu_customizations_sections_groups_options" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"label" varchar NOT NULL,
  ...
  CREATE TABLE "menu_customizations_sections_groups" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"group_title" varchar NOT NULL
  ...
  CREATE TABLE "menu_customizations_sections_options" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"label" varchar,
  ...
  CREATE TABLE "menu_customizations_sections" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"title" varchar NOT NULL,
  	"selection_type" "enum_menu_customizations_sections_selection_type"
  );
  ...
  CREATE TABLE "menu" (
  	...
  	"sale_price" numeric,
  	"dietary_type" "enum_menu_dietary_type" DEFAULT 'veg' NOT NULL,
  	"is_stamp_eligible" boolean,
  	"is_stamp_free_product" boolean,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  CREATE TABLE "shop" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"operational_settings_opening_time" timestamp(3) with time zone NOT NULL,
  	"operational_settings_closing_time" timestamp(3) with time zone NOT NULL,
  	"operational_settings_operating_days_monday" boolean DEFAULT true,
  	"operational_settings_operating_days_tuesday" boolean DEFAULT true,
  	"operational_settings_operating_days_wednesday" boolean DEFAULT true,
  	"operational_settings_operating_days_thursday" boolean DEFAULT true,
  	"operational_settings_operating_days_friday" boolean DEFAULT true,
  	"operational_settings_operating_days_saturday" boolean DEFAULT false,
  	"operational_settings_operating_days_sunday" boolean DEFAULT false,
  ...
  CREATE TABLE "shop_menu_customizations_sections_groups_options" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"label" varchar NOT NULL,
  ...
  CREATE TABLE "shop_menu_customizations_sections_groups" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"group_title" varchar NOT NULL
  ...
  CREATE TABLE "shop_menu_customizations_sections_options" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"label" varchar,
  ...
  CREATE TABLE "shop_menu_customizations_sections" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"title" varchar NOT NULL,
  	"selection_type" "enum_shop_menu_customizations_sections_selection_type"
  );
  
  CREATE TABLE "shop_menu_customizations" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"title" varchar,
  ...
  CREATE TABLE "shop_menu" (
  	...
  	"is_stamp_eligible" boolean DEFAULT false,
  	"is_stamp_free_product" boolean DEFAULT false,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  CREATE TABLE "surge_coupon" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"code" varchar,
  	"coupon_tagline" varchar,
  	"coupon_status" "enum_surge_coupon_coupon_status" DEFAULT 'active',
  	"discount_type" "enum_surge_coupon_discount_type" DEFAULT 'percentage',
  	"discount_amount" numeric,
  	"applicability" "enum_surge_coupon_applicability" DEFAULT 'all',
  	...
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"_status" "enum_surge_coupon_status" DEFAULT 'draft'
  );
  
  CREATE TABLE "surge_coupon_rels" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"order" integer,
  	"parent_id" integer NOT NULL,
  	"path" varchar NOT NULL,
  ...
  CREATE TABLE "_surge_coupon_v" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"parent_id" integer,
  	"version_code" varchar,
  	"version_coupon_tagline" varchar,
  	"version_coupon_status" "enum__surge_coupon_v_version_coupon_status" DEFAULT 'active',
  	"version_discount_type" "enum__surge_coupon_v_version_discount_type" DEFAULT 'percentage',
  	"version_discount_amount" numeric,
  	"version_applicability" "enum__surge_coupon_v_version_applicability" DEFAULT 'all',
  	"version_expiry_date" timestamp(3) with time zone,
  	"version_minimum_amount" numeric,
  	"version_usage_limit" numeric,
  	"version_usage_limit_per_user" numeric DEFAULT 1,
  	"version_created_by_id" integer,
  	"version_is_publicly_visible" boolean DEFAULT true,
  	"version_coupon_for_website" boolean,
  	"version_coupon_for_app" boolean,
  	"version_usage_count" numeric DEFAULT 0,
  	"version_updated_at" timestamp(3) with time zone,
  	"version_created_at" timestamp(3) with time zone,
  	"version__status" "enum__surge_coupon_v_version_status" DEFAULT 'draft',
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"latest" boolean,
  	"autosave" boolean
  ...
  CREATE TABLE "_surge_coupon_v_rels" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"order" integer,
  	"parent_id" integer NOT NULL,
  	"path" varchar NOT NULL,
  ...
  CREATE TABLE "surge_shop_coupon" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"code" varchar,
  	"coupon_status" "enum_surge_shop_coupon_coupon_status" DEFAULT 'active',
  	"discount_type" "enum_surge_shop_coupon_discount_type" DEFAULT 'percentage',
  	"discount_amount" numeric,
  	"applicability" "enum_surge_shop_coupon_applicability" DEFAULT 'all',
  	"expiry_date" timestamp(3) with time zone,
  	"minimum_amount" numeric,
  	"usage_limit" numeric,
  	"usage_limit_per_user" numeric DEFAULT 1,
  	...
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"_status" "enum_surge_shop_coupon_status" DEFAULT 'draft'
  );
  
  CREATE TABLE "surge_shop_coupon_rels" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"order" integer,
  	"parent_id" integer NOT NULL,
  	"path" varchar NOT NULL,
  	"shop_menu_id" integer,
  	"web_products_id" integer,
  	"surge_coupon_id" integer
  );
  
  CREATE TABLE "_surge_shop_coupon_v" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"parent_id" integer,
  	"version_code" varchar,
  	"version_coupon_status" "enum__surge_shop_coupon_v_version_coupon_status" DEFAULT 'active',
  	"version_discount_type" "enum__surge_shop_coupon_v_version_discount_type" DEFAULT 'percentage',
  	"version_discount_amount" numeric,
  	"version_applicability" "enum__surge_shop_coupon_v_version_applicability" DEFAULT 'all',
  	"version_expiry_date" timestamp(3) with time zone,
  	"version_minimum_amount" numeric,
  	"version_usage_limit" numeric,
  	"version_usage_limit_per_user" numeric DEFAULT 1,
  	...
  	"version_updated_at" timestamp(3) with time zone,
  	"version_created_at" timestamp(3) with time zone,
  	"version__status" "enum__surge_shop_coupon_v_version_status" DEFAULT 'draft',
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"latest" boolean
  );
  
  CREATE TABLE "_surge_shop_coupon_v_rels" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"order" integer,
  	"parent_id" integer NOT NULL,
  	"path" varchar NOT NULL,
  ...
  CREATE TABLE "app_orders" (
  	...
  	"app_order_status_dine" "enum_app_orders_app_order_status_dine" DEFAULT 'pending',
  	...
  	"order_rating" numeric,
  	"barista_rating" numeric,
  	...
  	"financials_coupon_discount" numeric,
  	"financials_surge_coins_discount" numeric,
  	"financials_tax_amount" numeric,
  	"financials_total" numeric,
  	"stripe_order_id" varchar,
  	"scheduled_for_prep" boolean DEFAULT false,
  	"is_stamps_awarded" boolean DEFAULT false,
  	"stripe_data" jsonb,
  	"invoice_id" varchar,
  ...
  CREATE TABLE "web_sub_categories_level1_level2_level3" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"name" varchar
  ...
  CREATE TABLE "web_sub_categories_level1_level2" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"name" varchar
  ...
  CREATE TABLE "web_sub_categories_level1" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"name" varchar NOT NULL
  ...
  CREATE TABLE "web_products" (
  	...
  	"name" varchar,
  	"tagline" varchar,
  	"product_type" "enum_web_products_product_type" DEFAULT 'coffee',
  ...
  CREATE TABLE "_web_products_v" (
  	...
  	"version_product_type" "enum__web_products_v_version_product_type" DEFAULT 'coffee',
  	...
  	"version_farm_description" varchar,
  ...
  CREATE TABLE "user_surge_coins_coin_earning_history" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"type" "enum_user_surge_coins_coin_earning_history_type" DEFAULT 'online',
  	"amount" numeric NOT NULL,
  	"remaining_amount" numeric NOT NULL,
  	"earned_at" timestamp(3) with time zone,
  	"offline_reference_id" varchar,
  	"expiry_date" timestamp(3) with time zone
  );
  
  CREATE TABLE "user_surge_coins_points_redemption_history" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"type" "enum_user_surge_coins_points_redemption_history_type" DEFAULT 'online',
  	"redeemed_points" numeric NOT NULL,
  	"offline_reference_id" varchar,
  	"redeemed_at" timestamp(3) with time zone
  );
  
  CREATE TABLE "user_surge_coins" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"user_id" integer NOT NULL,
  ...
  CREATE TABLE "user_surge_coins_rels" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"order" integer,
  	"parent_id" integer NOT NULL,
  	"path" varchar NOT NULL,
  ...
  CREATE TABLE "web_orders" (
  	...
  	"shipping_address_address_country" varchar DEFAULT 'United Arab Emirates',
  	...
  	"billing_address_address_country" varchar DEFAULT 'United Arab Emirates',
  	"payment_status" "enum_web_orders_payment_status" NOT NULL,
  	"delivery_status" "enum_web_orders_delivery_status" DEFAULT 'placed',
  	"delivering_by" timestamp(3) with time zone,
  	"delivered_on" timestamp(3) with time zone,
  	"is_pickup_ready" boolean DEFAULT false,
  	"picked_up_date" timestamp(3) with time zone,
  	"refund_reason" varchar,
  	"refunded_on" timestamp(3) with time zone,
  	"refunded_amount" numeric,
  	"coupon_code_id" integer,
  	"points_used" numeric,
  	"financials_subtotal" numeric NOT NULL,
  	"financials_shipping_charge" numeric,
  	"financials_coupon_discount" numeric,
  	"financials_surge_coins_discount" numeric,
  	"financials_tax_percentage" numeric,
  	"financials_tax_amount" numeric,
  ...
  CREATE TABLE "surge_stamps_stamp_earning_history" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"type" "enum_surge_stamps_stamp_earning_history_type" DEFAULT 'online',
  	"stamps" numeric NOT NULL,
  	"earned_at" timestamp(3) with time zone,
  	"offline_reference_id" varchar
  );
  
  CREATE TABLE "surge_stamps_stamps_redemption_history" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"redeemed_stamps" numeric NOT NULL,
  	"type" "enum_surge_stamps_stamps_redemption_history_type" DEFAULT 'online',
  	"offline_reference_id" varchar,
  	"redeemed_at" timestamp(3) with time zone
  );
  
  CREATE TABLE "surge_stamps" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"user_id" integer,
  ...
  CREATE TABLE "surge_stamps_rels" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"order" integer,
  	"parent_id" integer NOT NULL,
  	"path" varchar NOT NULL,
  ...
  CREATE TABLE "app_contact_form" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"full_name" varchar NOT NULL,
  	"email" varchar NOT NULL,
  	"inquiry_type" "enum_app_contact_form_inquiry_type" NOT NULL,
  ...
  CREATE TABLE "web_contact_form" (
  	...
  	"full_name" varchar NOT NULL,
  	"email" varchar NOT NULL,
  	"inquiry_type" "enum_web_contact_form_inquiry_type" NOT NULL,
  	"phone" varchar NOT NULL,
  	"message" varchar NOT NULL,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  ...
  CREATE TABLE "notifications_notifications" (
  	...
  	"origin" "enum_notifications_notifications_origin" NOT NULL,
  	"notification_type" "enum_notifications_notifications_notification_type" NOT NULL
  );
  ...
  CREATE TABLE "app_best_seller_rels" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"order" integer,
  	"parent_id" integer NOT NULL,
  	"path" varchar NOT NULL,
  ...
  CREATE TABLE "wholesale" (
  	...
  	"website_instagram" varchar,
  	"business_info_group_office" boolean,
  	"business_info_group_bakery" boolean,
  	"business_info_group_coffee_shop" boolean,
  	"business_info_group_restaurant" boolean,
  	"business_info_group_other" boolean,
  	"business_info_group_other_specification" varchar,
  	"message" varchar NOT NULL,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  CREATE TABLE "app_banners" (
  	...
  	"page" "enum_app_banners_page" NOT NULL,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  CREATE TABLE "payload_locked_documents_rels" (
  	...
  	"web_products_id" integer,
  	"web_cart_id" integer,
  	"user_surge_coins_id" integer,
  	"web_orders_id" integer,
  	"slots_id" integer,
  	"surge_stamps_id" integer,
  	"user_preferences_id" integer,
  	"app_contact_form_id" integer,
  	"web_contact_form_id" integer,
  	"notifications_id" integer,
  	"app_best_seller_id" integer,
  	"blogs_id" integer,
  	"wholesale_id" integer,
  	"app_banners_id" integer,
  ...
  CREATE TABLE "surge_coins" (
  	...
  	"referral_reward_for_referrer" numeric DEFAULT 0 NOT NULL,
  	"referral_reward_for_referred" numeric DEFAULT 0 NOT NULL,
  ...
  ALTER TABLE "menu_customizations_sections_groups_options" ADD CONSTRAINT "menu_customizations_sections_groups_options_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."menu_customizations_sections_groups"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "menu_customizations_sections_groups" ADD CONSTRAINT "menu_customizations_sections_groups_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."menu_customizations_sections"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "menu_customizations_sections_options" ADD CONSTRAINT "menu_customizations_sections_options_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."menu_customizations_sections"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "menu_customizations_sections" ADD CONSTRAINT "menu_customizations_sections_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."menu_customizations"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "menu_customizations" ADD CONSTRAINT "menu_customizations_template_id_customization_template_id_fk" FOREIGN KEY ("template_id") REFERENCES "public"."customization_template"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "menu_customizations" ADD CONSTRAINT "menu_customizations_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."menu"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "shop_menu_customizations_sections_groups_options" ADD CONSTRAINT "shop_menu_customizations_sections_groups_options_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."shop_menu_customizations_sections_groups"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "shop_menu_customizations_sections_groups" ADD CONSTRAINT "shop_menu_customizations_sections_groups_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."shop_menu_customizations_sections"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "shop_menu_customizations_sections_options" ADD CONSTRAINT "shop_menu_customizations_sections_options_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."shop_menu_customizations_sections"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "shop_menu_customizations_sections" ADD CONSTRAINT "shop_menu_customizations_sections_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."shop_menu_customizations"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "shop_menu_customizations" ADD CONSTRAINT "shop_menu_customizations_template_id_customization_template_id_fk" FOREIGN KEY ("template_id") REFERENCES "public"."customization_template"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "shop_menu_customizations" ADD CONSTRAINT "shop_menu_customizations_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."shop_menu"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "surge_coupon" ADD CONSTRAINT "surge_coupon_created_by_id_admins_id_fk" FOREIGN KEY ("created_by_id") REFERENCES "public"."admins"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "surge_coupon_rels" ADD CONSTRAINT "surge_coupon_rels_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."surge_coupon"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "surge_coupon_rels" ADD CONSTRAINT "surge_coupon_rels_shop_menu_fk" FOREIGN KEY ("shop_menu_id") REFERENCES "public"."shop_menu"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "surge_coupon_rels" ADD CONSTRAINT "surge_coupon_rels_web_products_fk" FOREIGN KEY ("web_products_id") REFERENCES "public"."web_products"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_surge_coupon_v" ADD CONSTRAINT "_surge_coupon_v_parent_id_surge_coupon_id_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."surge_coupon"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_surge_coupon_v" ADD CONSTRAINT "_surge_coupon_v_version_created_by_id_admins_id_fk" FOREIGN KEY ("version_created_by_id") REFERENCES "public"."admins"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_surge_coupon_v_rels" ADD CONSTRAINT "_surge_coupon_v_rels_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."_surge_coupon_v"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_surge_coupon_v_rels" ADD CONSTRAINT "_surge_coupon_v_rels_shop_menu_fk" FOREIGN KEY ("shop_menu_id") REFERENCES "public"."shop_menu"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_surge_coupon_v_rels" ADD CONSTRAINT "_surge_coupon_v_rels_web_products_fk" FOREIGN KEY ("web_products_id") REFERENCES "public"."web_products"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "surge_shop_coupon" ADD CONSTRAINT "surge_shop_coupon_shop_id_shop_id_fk" FOREIGN KEY ("shop_id") REFERENCES "public"."shop"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "surge_shop_coupon" ADD CONSTRAINT "surge_shop_coupon_created_by_id_admins_id_fk" FOREIGN KEY ("created_by_id") REFERENCES "public"."admins"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "surge_shop_coupon_rels" ADD CONSTRAINT "surge_shop_coupon_rels_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."surge_shop_coupon"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "surge_shop_coupon_rels" ADD CONSTRAINT "surge_shop_coupon_rels_shop_menu_fk" FOREIGN KEY ("shop_menu_id") REFERENCES "public"."shop_menu"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "surge_shop_coupon_rels" ADD CONSTRAINT "surge_shop_coupon_rels_web_products_fk" FOREIGN KEY ("web_products_id") REFERENCES "public"."web_products"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "surge_shop_coupon_rels" ADD CONSTRAINT "surge_shop_coupon_rels_surge_coupon_fk" FOREIGN KEY ("surge_coupon_id") REFERENCES "public"."surge_coupon"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_surge_shop_coupon_v" ADD CONSTRAINT "_surge_shop_coupon_v_parent_id_surge_shop_coupon_id_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."surge_shop_coupon"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_surge_shop_coupon_v" ADD CONSTRAINT "_surge_shop_coupon_v_version_shop_id_shop_id_fk" FOREIGN KEY ("version_shop_id") REFERENCES "public"."shop"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_surge_shop_coupon_v" ADD CONSTRAINT "_surge_shop_coupon_v_version_created_by_id_admins_id_fk" FOREIGN KEY ("version_created_by_id") REFERENCES "public"."admins"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_surge_shop_coupon_v_rels" ADD CONSTRAINT "_surge_shop_coupon_v_rels_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."_surge_shop_coupon_v"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_surge_shop_coupon_v_rels" ADD CONSTRAINT "_surge_shop_coupon_v_rels_shop_menu_fk" FOREIGN KEY ("shop_menu_id") REFERENCES "public"."shop_menu"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_surge_shop_coupon_v_rels" ADD CONSTRAINT "_surge_shop_coupon_v_rels_web_products_fk" FOREIGN KEY ("web_products_id") REFERENCES "public"."web_products"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_surge_shop_coupon_v_rels" ADD CONSTRAINT "_surge_shop_coupon_v_rels_surge_coupon_fk" FOREIGN KEY ("surge_coupon_id") REFERENCES "public"."surge_coupon"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "wishlist_items" ADD CONSTRAINT "wishlist_items_shop_id_shop_id_fk" FOREIGN KEY ("shop_id") REFERENCES "public"."shop"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "wishlist_rels" ADD CONSTRAINT "wishlist_rels_shop_menu_fk" FOREIGN KEY ("shop_menu_id") REFERENCES "public"."shop_menu"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "wishlist_rels" ADD CONSTRAINT "wishlist_rels_web_products_fk" FOREIGN KEY ("web_products_id") REFERENCES "public"."web_products"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "app_orders" ADD CONSTRAINT "app_orders_coupon_id_surge_shop_coupon_id_fk" FOREIGN KEY ("coupon_id") REFERENCES "public"."surge_shop_coupon"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "web_sub_categories_level1_level2_level3" ADD CONSTRAINT "web_sub_categories_level1_level2_level3_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."web_sub_categories_level1_level2"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "web_sub_categories_level1_level2" ADD CONSTRAINT "web_sub_categories_level1_level2_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."web_sub_categories_level1"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "web_sub_categories_level1" ADD CONSTRAINT "web_sub_categories_level1_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."web_sub_categories"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "web_products" ADD CONSTRAINT "web_products_categories_id_web_categories_id_fk" FOREIGN KEY ("categories_id") REFERENCES "public"."web_categories"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "web_products" ADD CONSTRAINT "web_products_updated_by_id_admins_id_fk" FOREIGN KEY ("updated_by_id") REFERENCES "public"."admins"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "web_products_rels" ADD CONSTRAINT "web_products_rels_web_products_fk" FOREIGN KEY ("web_products_id") REFERENCES "public"."web_products"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_web_products_v" ADD CONSTRAINT "_web_products_v_version_categories_id_web_categories_id_fk" FOREIGN KEY ("version_categories_id") REFERENCES "public"."web_categories"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_web_products_v" ADD CONSTRAINT "_web_products_v_version_updated_by_id_admins_id_fk" FOREIGN KEY ("version_updated_by_id") REFERENCES "public"."admins"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_web_products_v_rels" ADD CONSTRAINT "_web_products_v_rels_web_products_fk" FOREIGN KEY ("web_products_id") REFERENCES "public"."web_products"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "user_surge_coins_coin_earning_history" ADD CONSTRAINT "user_surge_coins_coin_earning_history_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."user_surge_coins"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "user_surge_coins_points_redemption_history" ADD CONSTRAINT "user_surge_coins_points_redemption_history_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."user_surge_coins"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "user_surge_coins" ADD CONSTRAINT "user_surge_coins_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "user_surge_coins_rels" ADD CONSTRAINT "user_surge_coins_rels_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."user_surge_coins"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "user_surge_coins_rels" ADD CONSTRAINT "user_surge_coins_rels_web_orders_fk" FOREIGN KEY ("web_orders_id") REFERENCES "public"."web_orders"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "user_surge_coins_rels" ADD CONSTRAINT "user_surge_coins_rels_app_orders_fk" FOREIGN KEY ("app_orders_id") REFERENCES "public"."app_orders"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "web_orders" ADD CONSTRAINT "web_orders_coupon_code_id_surge_coupon_id_fk" FOREIGN KEY ("coupon_code_id") REFERENCES "public"."surge_coupon"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "surge_stamps_stamp_earning_history" ADD CONSTRAINT "surge_stamps_stamp_earning_history_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."surge_stamps"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "surge_stamps_stamps_redemption_history" ADD CONSTRAINT "surge_stamps_stamps_redemption_history_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."surge_stamps"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "surge_stamps" ADD CONSTRAINT "surge_stamps_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "surge_stamps_rels" ADD CONSTRAINT "surge_stamps_rels_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."surge_stamps"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "surge_stamps_rels" ADD CONSTRAINT "surge_stamps_rels_web_orders_fk" FOREIGN KEY ("web_orders_id") REFERENCES "public"."web_orders"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "surge_stamps_rels" ADD CONSTRAINT "surge_stamps_rels_app_orders_fk" FOREIGN KEY ("app_orders_id") REFERENCES "public"."app_orders"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "notifications_notifications" ADD CONSTRAINT "notifications_notifications_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."notifications"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "app_best_seller" ADD CONSTRAINT "app_best_seller_shop_id_shop_id_fk" FOREIGN KEY ("shop_id") REFERENCES "public"."shop"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "app_best_seller_rels" ADD CONSTRAINT "app_best_seller_rels_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."app_best_seller"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "app_best_seller_rels" ADD CONSTRAINT "app_best_seller_rels_shop_menu_fk" FOREIGN KEY ("shop_menu_id") REFERENCES "public"."shop_menu"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "app_banners" ADD CONSTRAINT "app_banners_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_surge_coupon_fk" FOREIGN KEY ("surge_coupon_id") REFERENCES "public"."surge_coupon"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_surge_shop_coupon_fk" FOREIGN KEY ("surge_shop_coupon_id") REFERENCES "public"."surge_shop_coupon"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_user_surge_coins_fk" FOREIGN KEY ("user_surge_coins_id") REFERENCES "public"."user_surge_coins"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_surge_stamps_fk" FOREIGN KEY ("surge_stamps_id") REFERENCES "public"."surge_stamps"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_app_contact_form_fk" FOREIGN KEY ("app_contact_form_id") REFERENCES "public"."app_contact_form"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_web_contact_form_fk" FOREIGN KEY ("web_contact_form_id") REFERENCES "public"."web_contact_form"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_notifications_fk" FOREIGN KEY ("notifications_id") REFERENCES "public"."notifications"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_app_best_seller_fk" FOREIGN KEY ("app_best_seller_id") REFERENCES "public"."app_best_seller"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_wholesale_fk" FOREIGN KEY ("wholesale_id") REFERENCES "public"."wholesale"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_app_banners_fk" FOREIGN KEY ("app_banners_id") REFERENCES "public"."app_banners"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "menu_customizations_sections_groups_options_order_idx" ON "menu_customizations_sections_groups_options" USING btree ("_order");
  CREATE INDEX "menu_customizations_sections_groups_options_parent_id_idx" ON "menu_customizations_sections_groups_options" USING btree ("_parent_id");
  CREATE INDEX "menu_customizations_sections_groups_order_idx" ON "menu_customizations_sections_groups" USING btree ("_order");
  CREATE INDEX "menu_customizations_sections_groups_parent_id_idx" ON "menu_customizations_sections_groups" USING btree ("_parent_id");
  CREATE INDEX "menu_customizations_sections_options_order_idx" ON "menu_customizations_sections_options" USING btree ("_order");
  CREATE INDEX "menu_customizations_sections_options_parent_id_idx" ON "menu_customizations_sections_options" USING btree ("_parent_id");
  CREATE INDEX "menu_customizations_sections_order_idx" ON "menu_customizations_sections" USING btree ("_order");
  CREATE INDEX "menu_customizations_sections_parent_id_idx" ON "menu_customizations_sections" USING btree ("_parent_id");
  CREATE INDEX "menu_customizations_order_idx" ON "menu_customizations" USING btree ("_order");
  CREATE INDEX "menu_customizations_parent_id_idx" ON "menu_customizations" USING btree ("_parent_id");
  CREATE INDEX "menu_customizations_template_idx" ON "menu_customizations" USING btree ("template_id");
  ...
  CREATE INDEX "shop_menu_customizations_sections_groups_options_order_idx" ON "shop_menu_customizations_sections_groups_options" USING btree ("_order");
  CREATE INDEX "shop_menu_customizations_sections_groups_options_parent_id_idx" ON "shop_menu_customizations_sections_groups_options" USING btree ("_parent_id");
  CREATE INDEX "shop_menu_customizations_sections_groups_order_idx" ON "shop_menu_customizations_sections_groups" USING btree ("_order");
  CREATE INDEX "shop_menu_customizations_sections_groups_parent_id_idx" ON "shop_menu_customizations_sections_groups" USING btree ("_parent_id");
  CREATE INDEX "shop_menu_customizations_sections_options_order_idx" ON "shop_menu_customizations_sections_options" USING btree ("_order");
  CREATE INDEX "shop_menu_customizations_sections_options_parent_id_idx" ON "shop_menu_customizations_sections_options" USING btree ("_parent_id");
  CREATE INDEX "shop_menu_customizations_sections_order_idx" ON "shop_menu_customizations_sections" USING btree ("_order");
  CREATE INDEX "shop_menu_customizations_sections_parent_id_idx" ON "shop_menu_customizations_sections" USING btree ("_parent_id");
  CREATE INDEX "shop_menu_customizations_order_idx" ON "shop_menu_customizations" USING btree ("_order");
  CREATE INDEX "shop_menu_customizations_parent_id_idx" ON "shop_menu_customizations" USING btree ("_parent_id");
  CREATE INDEX "shop_menu_customizations_template_idx" ON "shop_menu_customizations" USING btree ("template_id");
  ...
  CREATE UNIQUE INDEX "surge_coupon_code_idx" ON "surge_coupon" USING btree ("code");
  CREATE INDEX "surge_coupon_created_by_idx" ON "surge_coupon" USING btree ("created_by_id");
  CREATE INDEX "surge_coupon_updated_at_idx" ON "surge_coupon" USING btree ("updated_at");
  CREATE INDEX "surge_coupon_created_at_idx" ON "surge_coupon" USING btree ("created_at");
  CREATE INDEX "surge_coupon__status_idx" ON "surge_coupon" USING btree ("_status");
  CREATE INDEX "surge_coupon_rels_order_idx" ON "surge_coupon_rels" USING btree ("order");
  CREATE INDEX "surge_coupon_rels_parent_idx" ON "surge_coupon_rels" USING btree ("parent_id");
  CREATE INDEX "surge_coupon_rels_path_idx" ON "surge_coupon_rels" USING btree ("path");
  CREATE INDEX "surge_coupon_rels_shop_menu_id_idx" ON "surge_coupon_rels" USING btree ("shop_menu_id");
  CREATE INDEX "surge_coupon_rels_web_products_id_idx" ON "surge_coupon_rels" USING btree ("web_products_id");
  CREATE INDEX "_surge_coupon_v_parent_idx" ON "_surge_coupon_v" USING btree ("parent_id");
  CREATE INDEX "_surge_coupon_v_version_version_code_idx" ON "_surge_coupon_v" USING btree ("version_code");
  CREATE INDEX "_surge_coupon_v_version_version_created_by_idx" ON "_surge_coupon_v" USING btree ("version_created_by_id");
  CREATE INDEX "_surge_coupon_v_version_version_updated_at_idx" ON "_surge_coupon_v" USING btree ("version_updated_at");
  CREATE INDEX "_surge_coupon_v_version_version_created_at_idx" ON "_surge_coupon_v" USING btree ("version_created_at");
  CREATE INDEX "_surge_coupon_v_version_version__status_idx" ON "_surge_coupon_v" USING btree ("version__status");
  CREATE INDEX "_surge_coupon_v_created_at_idx" ON "_surge_coupon_v" USING btree ("created_at");
  CREATE INDEX "_surge_coupon_v_updated_at_idx" ON "_surge_coupon_v" USING btree ("updated_at");
  CREATE INDEX "_surge_coupon_v_latest_idx" ON "_surge_coupon_v" USING btree ("latest");
  CREATE INDEX "_surge_coupon_v_autosave_idx" ON "_surge_coupon_v" USING btree ("autosave");
  CREATE INDEX "_surge_coupon_v_rels_order_idx" ON "_surge_coupon_v_rels" USING btree ("order");
  CREATE INDEX "_surge_coupon_v_rels_parent_idx" ON "_surge_coupon_v_rels" USING btree ("parent_id");
  CREATE INDEX "_surge_coupon_v_rels_path_idx" ON "_surge_coupon_v_rels" USING btree ("path");
  CREATE INDEX "_surge_coupon_v_rels_shop_menu_id_idx" ON "_surge_coupon_v_rels" USING btree ("shop_menu_id");
  CREATE INDEX "_surge_coupon_v_rels_web_products_id_idx" ON "_surge_coupon_v_rels" USING btree ("web_products_id");
  CREATE INDEX "surge_shop_coupon_shop_idx" ON "surge_shop_coupon" USING btree ("shop_id");
  CREATE INDEX "surge_shop_coupon_created_by_idx" ON "surge_shop_coupon" USING btree ("created_by_id");
  CREATE INDEX "surge_shop_coupon_updated_at_idx" ON "surge_shop_coupon" USING btree ("updated_at");
  CREATE INDEX "surge_shop_coupon_created_at_idx" ON "surge_shop_coupon" USING btree ("created_at");
  CREATE INDEX "surge_shop_coupon__status_idx" ON "surge_shop_coupon" USING btree ("_status");
  CREATE INDEX "surge_shop_coupon_rels_order_idx" ON "surge_shop_coupon_rels" USING btree ("order");
  CREATE INDEX "surge_shop_coupon_rels_parent_idx" ON "surge_shop_coupon_rels" USING btree ("parent_id");
  CREATE INDEX "surge_shop_coupon_rels_path_idx" ON "surge_shop_coupon_rels" USING btree ("path");
  CREATE INDEX "surge_shop_coupon_rels_shop_menu_id_idx" ON "surge_shop_coupon_rels" USING btree ("shop_menu_id");
  CREATE INDEX "surge_shop_coupon_rels_web_products_id_idx" ON "surge_shop_coupon_rels" USING btree ("web_products_id");
  CREATE INDEX "surge_shop_coupon_rels_surge_coupon_id_idx" ON "surge_shop_coupon_rels" USING btree ("surge_coupon_id");
  CREATE INDEX "_surge_shop_coupon_v_parent_idx" ON "_surge_shop_coupon_v" USING btree ("parent_id");
  CREATE INDEX "_surge_shop_coupon_v_version_version_shop_idx" ON "_surge_shop_coupon_v" USING btree ("version_shop_id");
  CREATE INDEX "_surge_shop_coupon_v_version_version_created_by_idx" ON "_surge_shop_coupon_v" USING btree ("version_created_by_id");
  CREATE INDEX "_surge_shop_coupon_v_version_version_updated_at_idx" ON "_surge_shop_coupon_v" USING btree ("version_updated_at");
  CREATE INDEX "_surge_shop_coupon_v_version_version_created_at_idx" ON "_surge_shop_coupon_v" USING btree ("version_created_at");
  CREATE INDEX "_surge_shop_coupon_v_version_version__status_idx" ON "_surge_shop_coupon_v" USING btree ("version__status");
  CREATE INDEX "_surge_shop_coupon_v_created_at_idx" ON "_surge_shop_coupon_v" USING btree ("created_at");
  CREATE INDEX "_surge_shop_coupon_v_updated_at_idx" ON "_surge_shop_coupon_v" USING btree ("updated_at");
  CREATE INDEX "_surge_shop_coupon_v_latest_idx" ON "_surge_shop_coupon_v" USING btree ("latest");
  CREATE INDEX "_surge_shop_coupon_v_rels_order_idx" ON "_surge_shop_coupon_v_rels" USING btree ("order");
  CREATE INDEX "_surge_shop_coupon_v_rels_parent_idx" ON "_surge_shop_coupon_v_rels" USING btree ("parent_id");
  CREATE INDEX "_surge_shop_coupon_v_rels_path_idx" ON "_surge_shop_coupon_v_rels" USING btree ("path");
  CREATE INDEX "_surge_shop_coupon_v_rels_shop_menu_id_idx" ON "_surge_shop_coupon_v_rels" USING btree ("shop_menu_id");
  CREATE INDEX "_surge_shop_coupon_v_rels_web_products_id_idx" ON "_surge_shop_coupon_v_rels" USING btree ("web_products_id");
  CREATE INDEX "_surge_shop_coupon_v_rels_surge_coupon_id_idx" ON "_surge_shop_coupon_v_rels" USING btree ("surge_coupon_id");
  ...
  CREATE INDEX "wishlist_items_shop_idx" ON "wishlist_items" USING btree ("shop_id");
  CREATE UNIQUE INDEX "wishlist_user_idx" ON "wishlist" USING btree ("user_id");
  ...
  CREATE INDEX "wishlist_rels_shop_menu_id_idx" ON "wishlist_rels" USING btree ("shop_menu_id");
  CREATE INDEX "wishlist_rels_web_products_id_idx" ON "wishlist_rels" USING btree ("web_products_id");
  ...
  CREATE UNIQUE INDEX "app_orders_invoice_id_idx" ON "app_orders" USING btree ("invoice_id");
  ...
  CREATE INDEX "web_sub_categories_level1_level2_level3_order_idx" ON "web_sub_categories_level1_level2_level3" USING btree ("_order");
  CREATE INDEX "web_sub_categories_level1_level2_level3_parent_id_idx" ON "web_sub_categories_level1_level2_level3" USING btree ("_parent_id");
  CREATE INDEX "web_sub_categories_level1_level2_order_idx" ON "web_sub_categories_level1_level2" USING btree ("_order");
  CREATE INDEX "web_sub_categories_level1_level2_parent_id_idx" ON "web_sub_categories_level1_level2" USING btree ("_parent_id");
  CREATE INDEX "web_sub_categories_level1_order_idx" ON "web_sub_categories_level1" USING btree ("_order");
  CREATE INDEX "web_sub_categories_level1_parent_id_idx" ON "web_sub_categories_level1" USING btree ("_parent_id");
  ...
  CREATE INDEX "web_products_categories_idx" ON "web_products" USING btree ("categories_id");
  ...
  CREATE INDEX "web_products_slug_idx" ON "web_products" USING btree ("slug");
  ...
  CREATE INDEX "web_products_rels_web_products_id_idx" ON "web_products_rels" USING btree ("web_products_id");
  ...
  CREATE INDEX "_web_products_v_version_version_categories_idx" ON "_web_products_v" USING btree ("version_categories_id");
  ...
  CREATE INDEX "_web_products_v_rels_web_products_id_idx" ON "_web_products_v_rels" USING btree ("web_products_id");
  ...
  CREATE INDEX "user_surge_coins_coin_earning_history_order_idx" ON "user_surge_coins_coin_earning_history" USING btree ("_order");
  CREATE INDEX "user_surge_coins_coin_earning_history_parent_id_idx" ON "user_surge_coins_coin_earning_history" USING btree ("_parent_id");
  CREATE INDEX "user_surge_coins_points_redemption_history_order_idx" ON "user_surge_coins_points_redemption_history" USING btree ("_order");
  CREATE INDEX "user_surge_coins_points_redemption_history_parent_id_idx" ON "user_surge_coins_points_redemption_history" USING btree ("_parent_id");
  CREATE UNIQUE INDEX "user_surge_coins_user_idx" ON "user_surge_coins" USING btree ("user_id");
  CREATE INDEX "user_surge_coins_updated_at_idx" ON "user_surge_coins" USING btree ("updated_at");
  CREATE INDEX "user_surge_coins_created_at_idx" ON "user_surge_coins" USING btree ("created_at");
  CREATE INDEX "user_surge_coins_rels_order_idx" ON "user_surge_coins_rels" USING btree ("order");
  CREATE INDEX "user_surge_coins_rels_parent_idx" ON "user_surge_coins_rels" USING btree ("parent_id");
  CREATE INDEX "user_surge_coins_rels_path_idx" ON "user_surge_coins_rels" USING btree ("path");
  CREATE INDEX "user_surge_coins_rels_web_orders_id_idx" ON "user_surge_coins_rels" USING btree ("web_orders_id");
  CREATE INDEX "user_surge_coins_rels_app_orders_id_idx" ON "user_surge_coins_rels" USING btree ("app_orders_id");
  ...
  CREATE UNIQUE INDEX "web_orders_invoice_id_idx" ON "web_orders" USING btree ("invoice_id");
  ...
  CREATE INDEX "surge_stamps_stamp_earning_history_order_idx" ON "surge_stamps_stamp_earning_history" USING btree ("_order");
  CREATE INDEX "surge_stamps_stamp_earning_history_parent_id_idx" ON "surge_stamps_stamp_earning_history" USING btree ("_parent_id");
  CREATE INDEX "surge_stamps_stamps_redemption_history_order_idx" ON "surge_stamps_stamps_redemption_history" USING btree ("_order");
  CREATE INDEX "surge_stamps_stamps_redemption_history_parent_id_idx" ON "surge_stamps_stamps_redemption_history" USING btree ("_parent_id");
  CREATE INDEX "surge_stamps_user_idx" ON "surge_stamps" USING btree ("user_id");
  CREATE INDEX "surge_stamps_updated_at_idx" ON "surge_stamps" USING btree ("updated_at");
  CREATE INDEX "surge_stamps_created_at_idx" ON "surge_stamps" USING btree ("created_at");
  CREATE INDEX "surge_stamps_rels_order_idx" ON "surge_stamps_rels" USING btree ("order");
  CREATE INDEX "surge_stamps_rels_parent_idx" ON "surge_stamps_rels" USING btree ("parent_id");
  CREATE INDEX "surge_stamps_rels_path_idx" ON "surge_stamps_rels" USING btree ("path");
  CREATE INDEX "surge_stamps_rels_web_orders_id_idx" ON "surge_stamps_rels" USING btree ("web_orders_id");
  CREATE INDEX "surge_stamps_rels_app_orders_id_idx" ON "surge_stamps_rels" USING btree ("app_orders_id");
  ...
  CREATE INDEX "app_contact_form_updated_at_idx" ON "app_contact_form" USING btree ("updated_at");
  CREATE INDEX "app_contact_form_created_at_idx" ON "app_contact_form" USING btree ("created_at");
  CREATE INDEX "web_contact_form_updated_at_idx" ON "web_contact_form" USING btree ("updated_at");
  CREATE INDEX "web_contact_form_created_at_idx" ON "web_contact_form" USING btree ("created_at");
  CREATE INDEX "notifications_notifications_order_idx" ON "notifications_notifications" USING btree ("_order");
  CREATE INDEX "notifications_notifications_parent_id_idx" ON "notifications_notifications" USING btree ("_parent_id");
  CREATE UNIQUE INDEX "notifications_user_idx" ON "notifications" USING btree ("user_id");
  CREATE INDEX "notifications_updated_at_idx" ON "notifications" USING btree ("updated_at");
  CREATE INDEX "notifications_created_at_idx" ON "notifications" USING btree ("created_at");
  CREATE UNIQUE INDEX "app_best_seller_shop_idx" ON "app_best_seller" USING btree ("shop_id");
  CREATE INDEX "app_best_seller_updated_at_idx" ON "app_best_seller" USING btree ("updated_at");
  CREATE INDEX "app_best_seller_created_at_idx" ON "app_best_seller" USING btree ("created_at");
  CREATE INDEX "app_best_seller_rels_order_idx" ON "app_best_seller_rels" USING btree ("order");
  CREATE INDEX "app_best_seller_rels_parent_idx" ON "app_best_seller_rels" USING btree ("parent_id");
  CREATE INDEX "app_best_seller_rels_path_idx" ON "app_best_seller_rels" USING btree ("path");
  CREATE INDEX "app_best_seller_rels_shop_menu_id_idx" ON "app_best_seller_rels" USING btree ("shop_menu_id");
  ...
  CREATE INDEX "wholesale_updated_at_idx" ON "wholesale" USING btree ("updated_at");
  CREATE INDEX "wholesale_created_at_idx" ON "wholesale" USING btree ("created_at");
  CREATE INDEX "app_banners_image_idx" ON "app_banners" USING btree ("image_id");
  CREATE INDEX "app_banners_updated_at_idx" ON "app_banners" USING btree ("updated_at");
  CREATE INDEX "app_banners_created_at_idx" ON "app_banners" USING btree ("created_at");
  ...
  CREATE INDEX "payload_locked_documents_rels_surge_coupon_id_idx" ON "payload_locked_documents_rels" USING btree ("surge_coupon_id");
  CREATE INDEX "payload_locked_documents_rels_surge_shop_coupon_id_idx" ON "payload_locked_documents_rels" USING btree ("surge_shop_coupon_id");
  ...
  CREATE INDEX "payload_locked_documents_rels_user_surge_coins_id_idx" ON "payload_locked_documents_rels" USING btree ("user_surge_coins_id");
  ...
  CREATE INDEX "payload_locked_documents_rels_surge_stamps_id_idx" ON "payload_locked_documents_rels" USING btree ("surge_stamps_id");
  ...
  CREATE INDEX "payload_locked_documents_rels_app_contact_form_id_idx" ON "payload_locked_documents_rels" USING btree ("app_contact_form_id");
  CREATE INDEX "payload_locked_documents_rels_web_contact_form_id_idx" ON "payload_locked_documents_rels" USING btree ("web_contact_form_id");
  ...
  CREATE INDEX "payload_locked_documents_rels_app_best_seller_id_idx" ON "payload_locked_documents_rels" USING btree ("app_best_seller_id");
  CREATE INDEX "payload_locked_documents_rels_blogs_id_idx" ON "payload_locked_documents_rels" USING btree ("blogs_id");
  CREATE INDEX "payload_locked_documents_rels_wholesale_id_idx" ON "payload_locked_documents_rels" USING btree ("wholesale_id");
  CREATE INDEX "payload_locked_documents_rels_app_banners_id_idx" ON "payload_locked_documents_rels" USING btree ("app_banners_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "menu_customizations_sections_groups_options" CASCADE;
  DROP TABLE "menu_customizations_sections_groups" CASCADE;
  DROP TABLE "menu_customizations_sections_options" CASCADE;
  DROP TABLE "menu_customizations_sections" CASCADE;
  DROP TABLE "menu_customizations" CASCADE;
  DROP TABLE "menu" CASCADE;
  DROP TABLE "menu_rels" CASCADE;
  DROP TABLE "shop" CASCADE;
  DROP TABLE "shop_menu_customizations_sections_groups_options" CASCADE;
  DROP TABLE "shop_menu_customizations_sections_groups" CASCADE;
  DROP TABLE "shop_menu_customizations_sections_options" CASCADE;
  DROP TABLE "shop_menu_customizations_sections" CASCADE;
  DROP TABLE "shop_menu_customizations" CASCADE;
  DROP TABLE "shop_menu" CASCADE;
  DROP TABLE "shop_menu_rels" CASCADE;
  DROP TABLE "surge_coupon" CASCADE;
  DROP TABLE "surge_coupon_rels" CASCADE;
  DROP TABLE "_surge_coupon_v" CASCADE;
  DROP TABLE "_surge_coupon_v_rels" CASCADE;
  DROP TABLE "surge_shop_coupon" CASCADE;
  DROP TABLE "surge_shop_coupon_rels" CASCADE;
  DROP TABLE "_surge_shop_coupon_v" CASCADE;
  DROP TABLE "_surge_shop_coupon_v_rels" CASCADE;
  ...
  DROP TABLE "web_sub_categories_level1_level2_level3" CASCADE;
  DROP TABLE "web_sub_categories_level1_level2" CASCADE;
  DROP TABLE "web_sub_categories_level1" CASCADE;
  ...
  DROP TABLE "user_surge_coins_coin_earning_history" CASCADE;
  DROP TABLE "user_surge_coins_points_redemption_history" CASCADE;
  DROP TABLE "user_surge_coins" CASCADE;
  DROP TABLE "user_surge_coins_rels" CASCADE;
  DROP TABLE "web_orders_items" CASCADE;
  DROP TABLE "web_orders" CASCADE;
  DROP TABLE "slots" CASCADE;
  DROP TABLE "surge_stamps_stamp_earning_history" CASCADE;
  DROP TABLE "surge_stamps_stamps_redemption_history" CASCADE;
  DROP TABLE "surge_stamps" CASCADE;
  DROP TABLE "surge_stamps_rels" CASCADE;
  DROP TABLE "user_preferences_cafe_product_preferences" CASCADE;
  DROP TABLE "user_preferences" CASCADE;
  DROP TABLE "app_contact_form" CASCADE;
  DROP TABLE "web_contact_form" CASCADE;
  DROP TABLE "notifications_notifications" CASCADE;
  DROP TABLE "notifications" CASCADE;
  DROP TABLE "app_best_seller" CASCADE;
  DROP TABLE "app_best_seller_rels" CASCADE;
  ...
  DROP TABLE "app_banners" CASCADE;
  ...
  DROP TYPE "public"."enum_menu_customizations_sections_selection_type";
  ...
  DROP TYPE "public"."enum_surge_coupon_coupon_status";
  DROP TYPE "public"."enum_surge_coupon_discount_type";
  DROP TYPE "public"."enum_surge_coupon_applicability";
  DROP TYPE "public"."enum_surge_coupon_status";
  DROP TYPE "public"."enum__surge_coupon_v_version_coupon_status";
  DROP TYPE "public"."enum__surge_coupon_v_version_discount_type";
  DROP TYPE "public"."enum__surge_coupon_v_version_applicability";
  DROP TYPE "public"."enum__surge_coupon_v_version_status";
  DROP TYPE "public"."enum_surge_shop_coupon_coupon_status";
  DROP TYPE "public"."enum_surge_shop_coupon_discount_type";
  DROP TYPE "public"."enum_surge_shop_coupon_applicability";
  DROP TYPE "public"."enum_surge_shop_coupon_status";
  DROP TYPE "public"."enum__surge_shop_coupon_v_version_coupon_status";
  DROP TYPE "public"."enum__surge_shop_coupon_v_version_discount_type";
  DROP TYPE "public"."enum__surge_shop_coupon_v_version_applicability";
  DROP TYPE "public"."enum__surge_shop_coupon_v_version_status";
  ...
  DROP TYPE "public"."enum_app_orders_app_order_status_dine";
  ...
  DROP TYPE "public"."enum_web_products_product_type";
  DROP TYPE "public"."enum_web_products_status";
  DROP TYPE "public"."enum__web_products_v_version_product_type";
  DROP TYPE "public"."enum__web_products_v_version_status";
  DROP TYPE "public"."enum_user_surge_coins_coin_earning_history_type";
  DROP TYPE "public"."enum_user_surge_coins_points_redemption_history_type";
  ...
  DROP TYPE "public"."enum_surge_stamps_stamp_earning_history_type";
  DROP TYPE "public"."enum_surge_stamps_stamps_redemption_history_type";
  DROP TYPE "public"."enum_app_contact_form_inquiry_type";
  DROP TYPE "public"."enum_web_contact_form_inquiry_type";
  DROP TYPE "public"."enum_notifications_notifications_origin";
  DROP TYPE "public"."enum_notifications_notifications_notification_type";
  DROP TYPE "public"."enum_blogs_status";
  DROP TYPE "public"."enum__blogs_v_version_status";
  DROP TYPE "public"."enum_app_banners_page";
